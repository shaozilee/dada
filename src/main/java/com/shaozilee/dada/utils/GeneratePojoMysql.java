...
public class GeneratePojoMysql {
    ...
    private String packageOutPath = "com.shaozilee.dada.pojo";//指定实体生成所在包的路径
    ...
    private void generatePojoClass(String tablename) throws Exception {
        ...
        String outputPath = directory.getAbsolutePath() + "/dada/src/main/java/" + this.packageOutPath.replace(".", "/") + "/" +
                            pojoClazz + ".java";
